...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>String</td>
      <td rowspan="2">Details (user ID and email) of the <strong>sharee of the originator of the agreement</strong> who sent the agreement on behalf of the sender in the case of account sharing.</td>
    </tr>
    <tr>
