...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>String</td>
      <td rowspan="2"><p>Details (user ID and email) of the <strong>last action taker.</strong> This can be the signer or the delegatee.</p></td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>&nbsp;</td>
    </tr><td><code>signedDocumentInfo</code></td>
      <td>Object</td>
      <td>Base64-encoded signed document</td>
      <td>&nbsp;</td>
    <tr>
