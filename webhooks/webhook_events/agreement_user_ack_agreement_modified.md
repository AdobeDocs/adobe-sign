...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>String</td>
      <td rowspan="2"><p>Details (user ID and email) of the <strong>user who acknowledged the agreement modifications.</strong> This can be the signer or the delegatee.</p></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>String</td>
      <td rowspan="2"><p>Both these fields will never be part of the paylosd.</p></td>
    </tr>
    <tr>
