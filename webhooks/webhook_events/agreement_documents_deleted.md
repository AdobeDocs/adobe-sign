...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>String</td>
      <td rowspan="2"><p>Details (user ID and email) of the <strong>sharee of the originator of the agreement</strong> who deleted the documents on behalf of the sender in the case of account sharing.</p></td>
    </tr>
    <tr>
