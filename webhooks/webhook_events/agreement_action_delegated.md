  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td><code>DELEGATED</code>, <code>AUTO_DELEGATED</code></td>
      </tr>
      <tr>
        <td><code>participantUserId</code></td>
        <td>String</td>
        <td rowspan="2">Details (User Id and Email) of the <strong>delegatee.</strong></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>String</td>
        <td rowspan="2">Details (User Id and Email) of the <strong>delegator.</strong></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
