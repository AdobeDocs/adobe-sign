...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>String</td>
      <td rowspan="2">Details (user ID and email) of the <strong>sharee of the creator of the megasign</strong> who created the MegaSign on behalf of the creator in the case of account sharing.</td>
    </tr>
    <tr>
