...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>RECALLED</code>, <code>MAX_SIGNING_KBA_ATTEMPTS_EXCEEDED</code>, <code>MAX_SIGNING_PASSWORD_ATTEMPTS_EXCEEDED</code>, <code>MAX_SIGNING_PHONE_ATTEMPTS_EXCEEDED</code></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>String</td>
      <td rowspan="2"><p>Details (user ID and email) of the <strong>sharee of the originator of the agreement</strong> who recalled the agreement on behalf of the sender in the case of account sharing.</p></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
